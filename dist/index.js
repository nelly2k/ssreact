...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "030d5c0f8db5293f466c";
...
var _a = Object({"BUILD_TARGET":"server"}).PORT, PORT = _a === void 0 ? 3000 : _a;
app.listen(PORT, function () { return console.log('######## app running ########'); });
if (true) {
    module.hot.accept(!(function webpackMissingModule() { var e = new Error("Cannot find module '*'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), function () {
        console.log("hot!");
    });
}
